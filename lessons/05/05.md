...
Questo ha portato a una sottostima dei dati e all’interruzione del tracciamento di molte catene di contagio.
...
In un'ottica a lungo termine, conserva i dati in un formato consistente che ne assicura la lettura e la gestione nel futuro e su più sistemi e applicazioni possibili. 
...
Conserva una copia di backup su un servizio web esterno (es. OneDrive, GitHub, ecc.).
