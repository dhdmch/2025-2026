...
Durante le fasi di gestione dei dati, dobbiamo capire come i nostri dati sono organizzati (o organizzabili).

Sappiamo che in Python i dati possono essere stringhe, numeri, o booleani. Fino ad ora li abbiamo sempre gestiti separatamente, ma spesso e volentieri dobbiamo lavorare con _gruppi_ di dati un po' più complessi, ciò che chiamiamo _strutture dati_.

## [Link alla sessione pratica](https://colab.research.google.com/drive/14g-1sWC1xvGOyhCmnJPQm3ysUQdM-zHg?usp=sharing)
