...
💡 Anche dati perfettamente corretti, se non gestiti, comunicati e descritti in mainera coerente, portano a conseguenze catastrofiche.
...
### Gli stessi dati possono essere organizzati e descritti in maniera diversa

I dati **non-strutturati** mancano formalmente di una struttura organizzata (testo libero, immagini, video).

I dati **semi-strutturati** hanno una struttura parziale e flessibile (XML).

I dati **strutturati** sono organizzati in uno schema rigido e predefinito (database).

A dire il vero, questo è un [ossimoro](https://www.techtarget.com/searchdatamanagement/blog/The-Wondrous-World-of-Data/Unstructured-data-is-a-misnomer).
...
I dati bibliografici (come i riferimenti o le citazioni) sono ampiamente utilizzati in virtualmente tutti gli ambiti di ricerca, dalla biologia all'informatica, fino ad arrivare ovviamente alla biblioteconomia e alle DH.
...
A tutti gli effetti, questo riferimento è una **stringa** (in informatica, è il termine utilizzato per riferirsi al testo), quindi un dato _non-strutturato_.

Ma sappiamo che in realtà un riferimento bibliografico (come anche altre tipologie di testo "semplice") ha una struttura _implicita_, determinata dallo stile citazionale scelto, che ci permette di dire una serie di _cose_ su questo dato...
...
Se ricordate, i metadati sono rappresentazioni formali (e possibilmente standardizzate) di tutto ciò che si può dire su dei dati in un determinato momento, a qualsiasi livello di aggregazione.
...
La metadatazione è una questione complessa: possiamo descrivere tutto, come vogliamo, e pure su diversi livelli... A quel punto, a cosa serve?
...
Gli **schemi di metadati** sono _strutture concettuali che specificano quali metadati utilizzare e secondo quali regole_.
...
Dublin Core (DC) è uno degli standard di metadati più semplici e utilizzati, una sorta di minimo comune denominatore.
...
### Altre tipologie di standard rilevanti
