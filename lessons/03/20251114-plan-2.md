...
### Sessione pratica: le _strutture dati_

Sulla scia della lezione di ieri, continuiamo a ragionare sui dati.

Quando programmiamo, spesso gestiamo dati all'interno di contenitori che ci permettono di fare svariate cose: le _**strutture dati**_.

Oggi vedremo le principali strutture dati usate in Python (e, in forme diverse, condivise anche da altri linguaggi di programmazione).
