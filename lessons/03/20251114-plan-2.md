...
### Sessione pratica: i _dati in Python_

Sulla scia della lezione di ieri, continuiamo a ragionare sui dati.

Quando programmiamo, lavoriamo sistematicamente con dati appartenenti ad una serie di _primitivi_ - tipologie che determinano cosa possiamo fare con i dati appartenenti ad esse.

Oggi vedremo i principali tipi di dati usati in Python (e, in forme diverse, condivisi anche da altri linguaggi di programmazione).

## [Link alla sessione pratica](https://colab.research.google.com/drive/1KUjFszDyFVS7mIWk0Z-llRH3g1V1KhGO?usp=sharing)
