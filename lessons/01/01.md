...
Una forma di documentazione strutturata che descrive o rappresenta le caratteristiche di un oggetto
...
Levels of metadata
There are three levels of data groupings: data objects (Items and Sub-items) can be collected into
groups (Collections):
1. Sub-item level - sometimes single objects can be made up of component parts: a book has
chapters, a documentary has scenes, a relational database has tables, and so on. To search for a
particular sub-item component requires not just the item-level metadata but also its sub-item or
component level metadata.
2. Item level metadata describes individual objects.
3. Collection level metadata describes the collection as a whole.

---

### Esistono diversi tipi di metadati

Ecco una classificazione parziale:

Descrittivi: permettono la scoperta, l’identificazione e la selezione della risorsa. Includono elementi come “titolo”, “autore”, ecc.; Descriptive metadata is all about content. It describes and identifies data with details that make it searchable and retrievable. For instance, in a database that stores information about books, the descriptive metadata might include the title, author, publication date, and summary of each book. This type of metadata often aids in categorizing, searching, and managing specific entries or records within a database.
Strutturali: This type of metadata provides information about the construction and organization of data within a database. It helps users understand how data is arranged, how tables relate to one another, and how data is stored. For example, structural metadata would tell you about table names, column data types, primary and foreign keys, and relationships between tables. In essence, structural metadata paints a picture of the database's architecture;
Amministrativi: facilitano la gestione della risorsa. Includono elementi come “identificativo”, “licenza”, “provenienza”, ecc. As the name suggests, administrative metadata helps with the management and maintenance of a database. It provides information about when and how data was created, who can access it, security protocols, backup schedules, and more. In simple terms, administrative metadata acts as the record-keeper for a database's operational and access-related details.
...
![bg right](img/125.jpeg)

### Dataset storico-artistico

#### Descrizione
Dataset costituito da metadati descrittivi di X dipinti appartenenti alla corrente del Romanticismo.

#### Opportunità
Implementazione di un progetto di **cultural analytics** ...

---

![bg right](img/126.jpeg)

### Dataset bibliografico

#### Descrizione
Dataset costituito da metadati descrittivi di X pubblicazioni scientifiche che trattano del Romanticismo.

#### Opportunità
Implementazione di un progetto di **bibliometrics** ...
