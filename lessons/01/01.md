...
(first perspective)
1. “humanities computing” (1980s, 1990s)
• text oriented
• digitization of source materials
(newspapers, etc)
• using computers for
organizing source materials
(indexing, counting, concordance, etc)
...
(second perspective)
2. “digital humanities” (2000s-2010s)
• includes speech, music, film, etc. as source materials
• also “born digital” materials
(e.g. social media, TV)
• scholarship using digital methods, digital tools,
and digital techniques (examples to follow)
• focus shifts from sources to methods (epistemology)

---

key computational concepts
• automation, iteration for each X do VERB(X)
wc –w *.txt > wordcount.out
• abstraction all X have same traits; compositionality
uncle(X) <- brother(parent(X))
• recursion output = input for next iteration
...
grandparent(X) <- parent(parent(X))
print( table(table(X) )
Berry & Fagerjord, 2017, Ch.4
11
key computational concepts
combined in algorithm:
“recipe”, systematic procedure
taking input (ingredients) and
producing output (dish)
e.g. from {viewing|reading} to {recommendations}
while optimizing for {profit}

---

macroscopes
Macroscopes provide a “vision of the whole,” helping us
“synthesize” the related elements and detect patterns,
trends, and outliers while granting access to myriad details.
Rather than make things larger or smaller, macroscopes let
us observe what is at once too great, slow, or complex for
the human eye and mind to notice and comprehend.
Börner (2011; 10.1145/1897852.1897871)
macroscopes can be datasets, tools, web services,
infrastructures, data streams ...
...
(third perspective)
3. computational turn as object of Humanities study
• similar digital data as in second wave
• scholarship using digital models and methods
• focus shifts from methods to social impact of
datafication, digitization, and algorithmification
(e.g. Netflix, Facebook, etc etc)
• societal impact of artificial intelligence
• rather Euro-Anglo-centric?
...
• interdisciplinary cooperation (technical, academic)
etc
...
/List/Best-Jobs-in-America-
LST_KQ0,20.htm
“...By adding a relatively small dose of
field-specific skills to a Liberal Arts
[Humanities, hq] program of study,
students can significantly improve and
broaden their labor market prospects.
(...) These skill sets are Marketing,
Sales, Business, Social Media, Graphic
Design, Data Analysis, Computer
Programming and IT Networking.
...
* Manipolazione, pulizia e visualizzazione dei dati tramite **SQL** 
* Documentazione non strutturata in **Markdown**
* Documentazione strutturata tramite **standard di metadati**
