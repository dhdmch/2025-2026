...
⚠️ Non c'è differenza tra il fenomeno osservato e l'osservazione?
...
![bg right contain "Stéfan Sinclair and Geoffrey Rockwell, CC BY 4.0 <https://creativecommons.org/licenses/by/4.0>, via Wikimedia Commons"](img/0117.png)
...
![bg "Stéfan Sinclair and Geoffrey Rockwell, CC BY 4.0 <https://creativecommons.org/licenses/by/4.0>, via Wikimedia Commons"](img/0118.png)
...
![bg right contain "Betik, B. & Cors, A. (2023). 5 Reasons Why All Graduate Education Should Include the Digital Humanities. Edinburgh University Press. https://euppublishingblog.com/2023/10/20/graduate-education-digital-humanities/"](img/0119.png)
...
![bg contain "Betik, B. & Cors, A. (2023). 5 Reasons Why All Graduate Education Should Include the Digital Humanities. Edinburgh University Press. https://euppublishingblog.com/2023/10/20/graduate-education-digital-humanities/"](img/0120.png)

---

<!-- paginate: True -->

![bg right](img/0121.png)
...
Può essere un dataset, un servizo, un software, una metodologia...
...
![bg right](img/0125.png)

### Dataset storico-artistico: MYPOD

#### Descrizione
Dataset costituito da metadati descrittivi di X dipinti che trattano di _mitologia classica_.

#### Opportunità
Implementazione di un progetto di [**cultural analytics**](https://en.wikipedia.org/wiki/Cultural_analytics). 

Per esempio, potete analizzare la frequenza di specifici soggetti mitologici nel tempo e tra diversi autori.

---

![bg right](img/0126.png)

### Dataset bibliografico: INPOD

#### Descrizione
Dataset costituito da metadati descrittivi di X pubblicazioni scientifiche che trattano di _information technology_.

#### Opportunità
Implementazione di un progetto di [**bibliometria**](https://it.wikipedia.org/wiki/Bibliometria). 

Per esempio, potete studiare l'evoluzione delle tematiche di ricerca nel tempo e individuare gli autori più influenti.
