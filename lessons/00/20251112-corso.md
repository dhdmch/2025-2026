...
➡️ Link: https://forms.gle/dzUB5NPry7aiRKki9
...
➡️ Nelle sessioni pratiche, lavoreremo assieme con **piccoli esempi** e  **casi di studio** di gestione dei dati in cui vi aiuterò attivamente, per farvi sperimentare con gli strumenti e i metodi presentati a lezione.
...
L'anno scorso abbiamo sperimentato con software già esistenti e diversi approcci alla gestione dei dati di un caso di studio specifico.

#### Esempi dell'anno precedente

* [Roma-Sotterranea](https://glptr-gh.github.io/Roma-Sotterranea/)
...
⚠️ **Quest'anno sarà diverso**: meno strumenti, indicazioni più precise.
...
Ho predisposto [una _Gem_ (un agente AI che utilizza _Gemini_) che possa farvi da supporto durante il corso](https://gemini.google.com/gem/1jP2JvydYTq9pm7JiZLFcCowTliR2gBaD?usp=sharing).

Datele _prompt_ mirati: il [_prompt engineering_](https://www.promptingguide.ai/it/introduction) richede una certa precisione.

NON datele _prompt_ contenenti informazioni personali vostre né di altre persone.

Usatela quanto volete, ma ricordate: (1) non fidatevi mai ciecamente; (2)  l'esame sarà orale, mi dovrete spiegare le cose che avete fatto, e non c'è AI al mondo che lo possa fare al posto vostro.
