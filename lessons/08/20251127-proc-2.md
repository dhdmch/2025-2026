...
➡️ Per questo motivo è così importante **assicurarsi la correttezza dei dati**, soprattutto se questi possono presentare valori mancanti. Dobbiamo sempre assicurarci che i dati siano ben documentati e che gli eventuali casi problematici siano gestiti.
...
⚠️ In media, l'80% del lavoro sui dati è dedicato al processo di pulizia dei dati e alla loro preparazione per ulteriori manipolazioni e analisi.

---

<!-- footer: University of York (2024). Data: A Practical Guide. https //subjectguides.york.ac.uk/data -->

![bg right contain vertical](img/0806.png)
![bg contain](img/0807.png)
![bg contain](img/0808.png)
...
➡️ _**Osservazione**_: _un singolo dato per cui la misura, il conteggio o la descrizione di una o più variabili viene registrato_. Esempio: se stiamo raccogliendo le variabili sopracitate, ogni pianta è un'osservazione.
...
![bg right contain vertical](img/0805.png)
...
![bg right vertical contain](img/0809.png)
![bg right contain](img/0810.png)
...
![bg right contain](img/0811.png)
![bg right contain](img/0812.png)
...
![bg right](img/0815.jpg)

### Sessione pratica: Intro a Pandas

Abbiamo parlato di _data cleaning_, dei suoi principi, e della loro importanza durante il processo di gestione dei dati, e in particolare del loro processamento.

Esistono svariati strumenti e approcci per effettuare la bonifica dei dati. In Python, quando si lavora con dati tabellari, è pratica ampiamente condivisa quella di usare **_pandas_**, la libreria più utilizzata per l'analisi scientifica dei dati in Python.

## [Link alla sessione pratica](https://colab.research.google.com/drive/1xzLrk06JDOMQ4RGq9RHXR8iyeMuY9Wi_?usp=sharing)
